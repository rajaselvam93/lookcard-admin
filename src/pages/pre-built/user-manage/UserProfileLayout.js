...
import UserAccountDetailsPage from "./UserAccountDetails";
          ...
          <div className="card-aside-wrap">
              ...
              <div className="card-inner-group">
                ...
                <div className="card-inner p-0">
                  <ul className="link-list-menu">
                    ...
                    <li onClick={() => updateSm(false)}>
                      <Link
                        to={`${process.env.PUBLIC_URL}/user-account-details`}
                        className={
                          window.location.pathname === `${process.env.PUBLIC_URL}/user-account-details` ? "active" : ""
                        }
                      >
                        <Icon name="icon ni ni-file-docs"></Icon>
            ...
            <div className="card-inner card-inner-lg">
              ...
              <Switch>
                ...
                <Route
                  exact
                  path={`${process.env.PUBLIC_URL}/user-account-details`}
                  render={() => <UserAccountDetailsPage updateSm={updateSm} sm={sm} />}
                ></Route>
              </Switch>
            </div>
          </div>
